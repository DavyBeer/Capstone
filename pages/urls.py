...
from .views import HomePageView, Cat1PageView, Cat2PageView, Cat3PageView, Cat4PageView, Cat5PageView, Cat1DetailView, SignUpView, BlogCreateView

urlpatterns = [
    path('cat1/', Cat1PageView.as_view(), name='cat1'),
    path('cat1/<int:pk>/', Cat1DetailView.as_view(), name='post_detail'),
    path('cat1/new/', BlogCreateView.as_view(), name='post_new'),
